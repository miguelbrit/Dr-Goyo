         ...
         <div className="bg-card p-4 rounded-2xl shadow-soft space-y-3 border border-border-main">
            <div className="flex items-start gap-3">
               ...
               <div>
                  ...
                  <p className="text-sm text-gray-text leading-relaxed">{pharmacy.address}</p>
               </div>
            </div>
            <div className="h-px bg-border-main"></div>
            <div className="flex items-start gap-3">
               <Phone className="text-gray-light mt-1" size={20} />
               <div>
                  <p className="text-sm font-bold text-text-main">Teléfono</p>
                  <p className="text-sm text-gray-text">{pharmacy.phone}</p>
               </div>
            </div>
         </div>
