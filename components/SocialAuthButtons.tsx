...
export const SocialAuthButtons: React.FC<SocialAuthButtonsProps> = ({
  ...
  const textClasses = "font-semibold text-gray-700 text-sm";
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        <span className={textClasses}>Continuar con Google</span>
      </button>
      ...
      >
        ...
        <span className={textClasses}>Continuar con Apple</span>
      </button>
      ...
      >
        ...
        <span className={textClasses}>Continuar con Facebook</span>
      </button>
    </div>
  );
};
